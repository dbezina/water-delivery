...
public class KafkaConfig extends BaseKafkaConfig {
 ...
 /*   @Bean
   ...
   // inventory.stock_reserved
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, StockReservedEvent> stockReservedKafkaListenerFactory() {
        return listenerFactory(StockReservedEvent.class, Map.of(
                ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapServers,
                ConsumerConfig.GROUP_ID_CONFIG,consumerGroup ,
                ConsumerConfig.AUTO_OFFSET_RESET_CONFIG, autoOffsetReset
        ));
